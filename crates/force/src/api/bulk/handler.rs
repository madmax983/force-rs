...
impl<A: crate::auth::Authenticator> BulkHandler<A> {
    ...
    {
        use super::ingest::IngestJobBuilder;
        use super::types::JobOperation;
        #[cfg(feature = "bulk")]
    ...
    /// ```
    #[cfg(feature = "bulk")]
    pub async fn query<T>(&self, soql: &str) -> Result<super::query::BulkQueryStream<T, A>>
    where
    ...
    #[cfg(feature = "bulk")]
    pub async fn bulk_query<T>(&self, soql: &str) -> Result<super::query::BulkQueryStream<T, A>>
    where
        T: for<'de> serde::Deserialize<'de>,
    {
    ...
    ) -> Result<super::query::BulkQueryStream<T, A>>
    where
        T: for<'de> serde::Deserialize<'de>,
    {
        use super::query::BulkQueryRequest;
