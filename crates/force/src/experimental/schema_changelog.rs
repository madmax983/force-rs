...
//!
//! This module provides the `SchemaChangelogGenerator` utility to create a human-readable
//! Markdown changelog by comparing two `SObjectDescribe` payloads using `SchemaDiff`.
//!
//! # Example
//!
//! ```no_run
//! # use force::client::ForceClientBuilder;
//! # use force::experimental::{SchemaChangelogGenerator};
...
//!
//! let md_changelog = SchemaChangelogGenerator::generate_changelog(&describe_v1, &describe_v2);
...
use crate::experimental::SchemaDiff;

/// Utility for generating a Markdown changelog between two SObject schemas.
...
mod tests {
    ...
    fn test_schema_changelog_generator_no_changes() {
        ...
        let md = SchemaChangelogGenerator::generate_changelog(&schema_v1, &schema_v1);
    ...
    fn test_schema_changelog_generator_with_changes() {
        ...
        let md = SchemaChangelogGenerator::generate_changelog(&schema_v1, &schema_v2);
