...
mod tests {
    ...
    fn test_json_schema_generator_basic() {
        let json = r#"{
            ...
            "childRelationships": [], "recordTypeInfos": [], "supportedScopes": [], "fields": [
                ...
                },
                {
                    ...
                    "htmlFormatted": false,
                    "idLookup": false,
                    "inlineHelpText": "Created date help",
                    "label": "Created Date",
                    "length": 0,
                    "name": "CreatedDate",
                    "nameField": false,
        ...
        assert_eq!(props["Industry"]["type"], "string");
        assert_eq!(props["Industry"]["enum"][0], "Technology");

        assert_eq!(props["IsActive"]["type"], "boolean");
        assert_eq!(props["NumberOfEmployees"]["type"], "integer");
        assert_eq!(props["AnnualRevenue"]["type"], "number");

        assert_eq!(props["CreatedDate"]["type"], "string");
        assert_eq!(props["CreatedDate"]["format"], "date-time");
        assert_eq!(props["CreatedDate"]["description"], "Created date help");


        assert_eq!(props["SomeDate"]["type"], "string");
        assert_eq!(props["SomeDate"]["format"], "date");

        assert_eq!(props["File"]["type"], "string");
        assert_eq!(props["File"]["contentEncoding"], "base64");
