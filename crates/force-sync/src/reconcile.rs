...
async fn detect_drift_query<C>(client: &C, limit: i64) -> Result<Vec<DriftItem>>
where
...
async fn existing_repair_task_in_tx<C>(client: &C, journal_id: i64) -> Result<Option<i64>>
where
    C: GenericClient + Sync + ?Sized,
{
...
pub async fn detect_drift(store: &PgStore, limit: i64) -> Result<Vec<DriftItem>> {
