...
fn replay_id_to_position(replay_id: &ReplayId) -> crate::Result<i64> {
...
fn replay_id_from_position(position: i64) -> crate::Result<ReplayId> {
...
pub async fn load_replay_id(store: &PgStore, stream_name: &str) -> crate::Result<Option<ReplayId>> {
