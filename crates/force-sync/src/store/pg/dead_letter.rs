...
async fn insert_dead_letter_query<C>(client: &C, dead_letter: &DeadLetter) -> crate::Result<i64>
where
...
pub async fn insert_dead_letter_in_tx<C>(client: &C, dead_letter: &DeadLetter) -> crate::Result<i64>
where
    C: GenericClient + Sync + ?Sized,
{
...
impl PgStore {
    ...
    ///
    /// Returns an error if the database write fails.
    pub async fn insert_dead_letter(&self, dead_letter: &DeadLetter) -> crate::Result<i64> {
