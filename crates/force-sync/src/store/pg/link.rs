...
async fn put_link_query<C>(client: &C, link: &SyncLink) -> crate::Result<i64>
where
...
impl PgStore {
    ...
    pub async fn put_link(&self, link: &SyncLink) -> crate::Result<i64> {
