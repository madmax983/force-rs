...
async fn insert_conflict_query<C>(client: &C, conflict: &SyncConflict) -> crate::Result<i64>
where
...
impl PgStore {
    ...
    pub async fn insert_conflict(&self, conflict: &SyncConflict) -> crate::Result<i64> {
